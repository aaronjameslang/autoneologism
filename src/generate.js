 ...
 * @returns {{attempts: int, efficiency: float, words: string[]}}
 */
 ...
 *
 * @param {string} wordSoFar The beginning of the word, as much as has been built so far
 ...
 * @param {int} index A number between 0 and 1, used to select which letter to choose
